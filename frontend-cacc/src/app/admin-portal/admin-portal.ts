...
import { DtAdminChat } from '../shared/dt-admin-chat/dt-admin-chat';

@Component({
    selector: 'app-admin-portal',
    standalone: true,
    imports: [CommonModule, RouterOutlet, RouterLink, RouterLinkActive, Toast, NotificationBell, DtAdminChat],
